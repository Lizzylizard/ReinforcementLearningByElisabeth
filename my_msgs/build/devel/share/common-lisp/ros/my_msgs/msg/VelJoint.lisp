...
(cl:defmethod cl:initialize-instance :after ((m <VelJoint>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'VelJoint)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name my_msgs-msg:<VelJoint> is deprecated: use my_msgs-msg:VelJoint instead.")))

(cl:ensure-generic-function 'left_vel-val :lambda-list '(m))
(cl:defmethod left_vel-val ((m <VelJoint>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader my_msgs-msg:left_vel-val is deprecated.  Use my_msgs-msg:left_vel instead.")
  (left_vel m))

(cl:ensure-generic-function 'right_vel-val :lambda-list '(m))
(cl:defmethod right_vel-val ((m <VelJoint>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader my_msgs-msg:right_vel-val is deprecated.  Use my_msgs-msg:right_vel instead.")
  (right_vel m))
