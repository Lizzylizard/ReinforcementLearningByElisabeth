...
class Bot:
  ...
  def save_q_matrix(self, end, total_learning_time, episodes,
    ...
    try:
      # open correct file
      f = open(
        "/home/user/workspace/src/ReinforcementLearningByElisabeth/RLNodes/q_matrix/Q-Matrix-Records.txt",
        "a")
  ...
  def own_q_matrix(self, img):
    ...
    '''
    # line = far left, action = sharp left
    q[0] = [56.908, 56.924, 57.212, 56.952, 56.281, 64.421, 61.770]
    # line = left, action = left
    q[1] = [56.776, 54.137, 53.252, 56.935, 52.873, 61.927, 56.572]
    # line = slightly left, action = slightly left
    q[2] = [65.185, 63.567, 70.614, 61.366, 60.978, 69.107, 60.957]
    # line = middle, action = forward
    q[3] = [65.837, 69.682, 67.859, 66.714, 71.451, 69.202, 71.266]
    # line = slightly right, action = slightly right
    q[4] = [62.374, 60.915, 62.630, 61.198, 70.456, 68.869, 62.400]
    # line = right, action = right
    q[5] = [52.785, 52.668, 52.766, 52.474, 52.487, 67.765, 52.722]
    # line = far right, action = sharp right
    q[6] = [64.402, 58.094, 57.224, 57.506, 58.229, 57.402, 58.219]
    # line = lost, action = stop
    q[7] = [71.512, 70.402, 70.809, 73.075, 71.597, 71.491, 72.336]
